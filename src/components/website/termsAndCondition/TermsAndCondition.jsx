...
import termsAndConditionData from './termsAndCondition.json';
    ...
    >
      <Container maxWidth="lg">
        ...
        <Box sx={{ mb: 6, textAlign: 'center' }}>
          ...
          >
            Last Updated: {termsAndConditionData.lastUpdated}
          </Typography>
        </Box>
        ...
        >
          {termsAndConditionData.sections.map((section, index) => (
            <Box key={index} sx={{ mb: index < termsAndConditionData.sections.length - 1 ? 5 : 0 }}>
              <Typography
                variant="h4"
                component="h2"
                sx={{
              ...
              {index < termsAndConditionData.sections.length - 1 && (
                <Divider sx={{ mt: 4 }} />
              )}
            </Box>
          ))}
